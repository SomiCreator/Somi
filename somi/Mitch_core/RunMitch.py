...
from somi.ai_functions import generate_response, analyze_sentiment
from somi.logger import setup_logger

# Load environment variables
load_dotenv()

logger = setup_logger("mitch")
...
class mitchStreamListener(tweepy.StreamListener):
...
def main():
    ...
    print_letter_by_letter("🚀 mitch is now online and ready to interact! 🌐")
    time.sleep(1)
    print()  # Add an extra newline for spacing

    # Create Stream listener
    tweets_listener = mitchStreamListener(api)
